...
//   영상녹화하고 썸네일저장할때 버전 오류나서 써준 코드. 이해안됨
...
// form으로부터 오는 data를 서버가 이해 하게 만들어 req.body로 받아 올 수 있게끔 해주는 middleware이다.

// app.use(express.text());
// 누가 text를 보냈을때 backend가 이해 할 수 있도록 하고 ,req.body에 담아주는 middleware
// text 1개만 받을떈 이거 써도 됨. 그러나 2개 이상일떈 다른거 써야함.
app.use(express.json());
// express는 json stringify된 string을 받아서 다시 JS의 것으로 바꿔줌.
// 사용법 : JSON.parse()
//  그래도 console.log(req.body) 값은 빈값으로 나온다 이유는?
//  express는 text를 보내고 있다고 생각하므로 우리가 json을 보내고 있다고 알려줘야함
app.use(
    session({
